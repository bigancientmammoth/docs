...
Для базовой работы MarketAut выберите:
...
Набор необходимых категорий может отличаться в зависимости от инструментов, добавленных в диаграмму. Подробнее см. в разделе [«Получение API-токена»](/3-start/03-api-token/).
