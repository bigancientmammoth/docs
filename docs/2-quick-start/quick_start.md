...
После регистрации в MarketAut автоматически создаётся первая диаграмма и аккаунт. Они будут доступны сразу после входа в систему и могул использоваться как основа для настройки ваших интеграций.
...
После регистрации первый аккаунт уже создаётся автоматически. При необходимости вы можете создать новый аккаунт вручную.
...
> **Быстрое подключение всех инструментов**
> 
> Если необходимо предоставить ИИ доступ ко всем инструментам узла, используйте выход **ALL**. Соедините его со входом **tools** узла MCP, и все инструменты будут подключены автоматически.
