...
> ⚠️ **ВНИМАНИЕ:** для создания токена вы должны быть  владельцев личного кабинета Wildberries.
...
**Токен API** - вставьте API - токен , полученный в личном кабинете продавца Wildberries на предыдущем шаге.
...
Мы создали узел **Каталог товаров**, который позволяет работать с карточками товаров Wildberries.
...
Это значение необходимо указать при добавлении коннектора в Claude:
