...
Эта ссылка потребуется при подключении ChatGPT или Claude.
## Что дальше? 

После копирования ссылки перейдите в раздел [Работа с ИИ](../5-ai/00-intro.md) и выберите ChatGPT или Claude. Дополнительные аккаунты и диаграммы при необходимости можно создать позже в соответствующих разделах платформы.
