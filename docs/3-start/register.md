...
Если автоматическая авторизация не произошла (например, при входе с нового устройства или после выхода из аккаунта), выполните вход с помощью учетной записи Google или адреса электронной почты, использованных при регистрации.