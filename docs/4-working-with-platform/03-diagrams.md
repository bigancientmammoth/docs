...
**Диаграммы** - визуальные схемы, на которых строится логика автоматизации. На ней вы размещаете узлы на холсте и соединяете их между собой, выстраивая нужную логику работы.
...
Управление Диаграммами осуществляется в разделе [Конфигурация -> Диаграммы](https://marketaut.ru/app/config/diagrams)
