...
В этом разделе описан процесс подключения **QwenWork** к платформе MarketAut по протоколу [MCP](https://modelcontextprotocol.io).
...
- **Server URL** — вставьте персональный MCP-адрес, скопированный из блока подключения агента на [домашней странице MarketAut](https://marketaut.ru/app/home);
...
![](img/qwen/https-configuration.png)
