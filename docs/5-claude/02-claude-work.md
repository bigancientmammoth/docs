...
После изменения списка доступных инструментов в веб-интерфейсе MarketAut необходимо обновить их в Claude
...
Для настройки перейдите в раздел **Customize** и выберите нужный Connector **MarketAut**.
