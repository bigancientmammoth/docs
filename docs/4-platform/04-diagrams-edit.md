...
Обратите внимание: аккаунт должен быть создана заранее. Подробнее о создании аккаунтов см. в разделе [Аккаунты](01-accounts.md)
...
Например, узел **MCP** предоставляет ИИ доступ ко всем функциям,**подключённым** к его входу **tools**. 

Благодаря этому можно создавать ИИ-агентов с необходимым набором функций и ограничивать доступ только к тем инструментам, которые нужны для решения конкретной задачи.
...
Для создания связи нажмите на выход одного узла и, удерживая кнопку мыши, перетащите связь на вход другого узла.

Для **удаления** связи:
1. Выберите связь, которую необходимо удалить (щелкнув на ней мышкой)
