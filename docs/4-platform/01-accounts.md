...
Управление Аккаунтами осуществляется в разделе [Конфигурация -> Аккаунты](https://marketaut.ru/app/config/accounts)
...
1. Перейдите в [Конфигурация -> Аккаунты](https://marketaut.ru/app/config/accounts)
