...
Инструменты для получения справочной информации Wildberries, просмотра карточек товаров и управления ими.
...
Инструменты для просмотра и изменения цен на товары Wildberries.
...
Инструменты для просмотра отзывов покупателей и работы с ответами.
...
Инструменты для управления отзывами, закреплёнными в карточках товаров.
...
Инструменты для просмотра вопросов покупателей и отправки ответов.
...
Инструменты для общения с покупателями в чатах Wildberries.
...
Инструменты для работы с заявками покупателей на возврат товаров.
...
Инструменты для получения информации об удержаниях Wildberries.
...
Инструменты для формирования и загрузки отчёта об остатках товаров на складах Wildberries.
...
Инструмент для получения новостей Wildberries для продавцов.
...
Инструмент для просмотра оферты.
...
Инструменты для отправки сообщений и работы с файлами через Telegram.
