...
Блок позволяет получать справочники Wildberries, создавать, обновлять и удалять карточки товаров.
...
| `getSubjects` | Получает предметы |
| `getColors` | Получает цвета |
| `getGenders` | Получает варианты пола |
| `getCountries` | Получает страны |
...
| `attachCardPhoto` | Добавляет фотографию в карточку |
| `attachCardPhotoAsUrl` | Добавляет фотографию по ссылке |
...
| Инструмент           | Описание                                |
| -------------------- | --------------------------------------- |
| `moveCardToDeleted`  | Перемещает карточку в корзину           |
| `moveCardsToDeleted` | Перемещает несколько карточек в корзину |
| `deletedCards`       | Удаляет карточки                        |
